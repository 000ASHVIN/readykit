...
export default {
	...
	data() {
		...
		let columns = [
            ...
            // { label: "House Lot", name: "house_lot_num" },
            // { label: "S.N No.", name: "serial_num" },
            // { label: "Last Reading (liter)", name: "last_reading" },
            // { label: "Current Reading (liter)", name: "current_reading" },
            // { label: "Usage (liter)", name: "usage" },
            { label: "Date Submitted", name: "created_at" },
            // { label: "Image", name: "image" },
            // { label: "User", name: "first_name" }
		];
	...
	methods: {
		...
		getUsers() {
			axios
				.get("/admin/water_readings/branch/list", { params: this.tableShow })
				.then(response => {
...
// https://medium.com/js-dojo/building-your-own-datatable-with-laravel-and-vuejs-from-scratch-ad0b95ae0d2f
</script>
